Locales['pl'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'Mozesz odrodzic sie za [~p~%s~w~ minut i ~p~%s ~w~sekund]',
  ['respawn_bleedout_in'] = 'wykrwawisz się za %s:%s\n',
  ['respawn_bleedout_prompt'] = 'przytrzymaj [~p~E~w~], aby się odrodzić',
