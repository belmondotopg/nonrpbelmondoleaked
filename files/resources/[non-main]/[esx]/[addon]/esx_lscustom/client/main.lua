...
RegisterNetEvent('esx_lscustom:OpenLSMenu')
AddEventHandler('esx_lscustom:OpenLSMenu', function()
    OpenLSMenu()
end)
...
RegisterNetEvent('esx_lscustom:action')
AddEventHandler('esx_lscustom:action', function(data)
    GetAction(data)
end)
