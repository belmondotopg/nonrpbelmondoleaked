...
Config.Weapons = {
    ...
    },
	{
        ...
        components = {
			...
			{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey(`w_at_m9_flsh1`)},
        }
    },
	{
	...
	{
        name = 'WEAPON_SIGSPEARXM7',
        label = ('non_xm7'),
		item = "non_xm7",
		ammo = {label = _U('ammo_rounds'), hash = `AMMO_RIFLE`},
        components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('w_ar_sigspearxm7') },
        }
    },
-- WEAPON_ANIMEM4
	...
	{
        name = 'WEAPON_SIGMXCVIRTUS',
        label = ('non_mxcvirtus'),
		item = "non_mxcvirtus",
		ammo = {label = _U('ammo_rounds'), hash = `AMMO_RIFLE`},
        components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('w_ar_sigmxcvirtus_mag1') },
        }
    },
	-- {
    --     name = 'WEAPON_josak1',
	...
	-- 	ammo = {label = _U('ammo_rounds'), hash = `AMMO_RIFLE`},
    --     components = {
    --         { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('josakk_mag1') },
    --     }
    -- },
	{
        name = 'WEAPON_TOYM16',
		...
		ammo = {label = _U('ammo_rounds'), hash = `AMMO_RIFLE`},
        components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('w_ar_toym16_mag1') },
        }
    },
	-- {
	-- 	name = 'WEAPON_M270D',
	...
	-- 	ammo = { label = _U('ammo_rounds'), hash = `AMMO_PISTOL` },
	-- 	components = {
	-- 		{ name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey(`w_sb_m270d_mag1`)},
	-- 		{ name = 'clip_extended', label = _U('component_clip_extended'), hash = GetHashKey(`w_sb_m270d_mag2`)},
	-- 		{ name = 'scope', label = _U('component_scope'), hash = GetHashKey(`w_at_m270d_scope`) },
	-- 		{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey(`w_sb_m270d_supp`)},
	-- 		{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey(`w_at_m270d_flsh`)},
	-- 	}
	-- },
	{
