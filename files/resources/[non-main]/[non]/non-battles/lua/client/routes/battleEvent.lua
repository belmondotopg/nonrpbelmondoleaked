...
functions.spawnAfterBattleVehicle = function(vehicleData)
    ...
    ESX.Game.SpawnVehicle(props.model, vec3(spawnPos.x, spawnPos.y, spawnPos.z), spawnPos.w, function(vehicle)
       ...
       -- local rgb = config.vehicleColors[vehicleData.vehicleColors[1]]
       -- local rgb2 = config.vehicleColors[vehicleData.vehicleColors[2]]
       -- SetVehicleCustomPrimaryColour(vehicle, rgb[1], rgb[2], rgb[3])
       -- SetVehicleCustomSecondaryColour(vehicle, rgb2[1], rgb2[2], rgb2[3])
        SetVehicleFixed(vehicle)
