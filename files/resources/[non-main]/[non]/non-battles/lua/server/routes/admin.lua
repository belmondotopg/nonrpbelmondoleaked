...
ESX.RegisterServerCallback('non_battles:getOrgsList', server.getOrgsList)
RegisterNetEvent('non_battleCreator:addTeamToBattle', server.addTeamToBattle)
RegisterNetEvent('non_battleCreator:removeTeamFromBattle', server.removeTeamFromBattle)
RegisterNetEvent('non_battleCreator:startBattle', server.startBattle)