...
Client.OpenShop = function()
    ...
    TriggerServerEvent('non-itemshop:UpdatePlayer')
...
Client.GetInfoNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:getSteamPhotoUrl', function(callback)
...
Client.GetFreeCaseTimeNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:getFreeCaseTime', function(callback)
        cb(callback)
    end)
end

Client.OpenCaseNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:openCase', function(callback)
...
Client.SellItemNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:sellItem', function(callback)
        cb(callback.status)
...
Client.KeepItemNuiCallback = function(data)
    TriggerServerEvent('non-itemshop:server:keepItem', data.item)
end

Client.UpgradeItemNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:upgradeItem', function(callback)
        cb({
...
Client.BuyItemNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:buyItem', function(callback)
        cb(callback.status)
        Client.UpdatePlayerData(callback.data)
    end, data)
end
...
Client.WithdrawItemNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:withdrawItem', function(callback)
        cb(callback.status)
        if callback.status then
            Client.UpdatePlayerData(callback.data)
        end
...
Client.DiscountNuiCallback = function(data, cb)
    ESX.TriggerServerCallback('non-itemshop:callback:discount', function(callback)
        cb(callback.status)
        Client.UpdatePlayerData(callback.data)
    end, data)
end
...
RegisterNetEvent('non-itemshop:client:playerLoaded', Client.PlayerLoaded)
RegisterNetEvent('non-itemshop:client:updatePlayerData', Client.UpdatePlayerData)
RegisterNetEvent('non-itemshop:client:updateLiveDrop', Client.UpdateLivedrop)