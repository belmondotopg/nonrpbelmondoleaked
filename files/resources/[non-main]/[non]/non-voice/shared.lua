...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.0, "Szept"}, -- Whisper speech distance in gta distance units
		{6.0, "Normalny"}, -- Normal speech distance in gta distance units
		{12.0, "Krzyk"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
...
logger = {
	...
	warn = function(message, ...)
		exports['non']:ServerDebugPrint({type = "WARNING", message = (' ' .. message):format(...)})
	end,
