...
ESX.RegisterServerCallback('non-dressings:getPlayerDressing', function(source, cb)
...
ESX.RegisterServerCallback('non-dressings:getPlayerOutfit', function(source, cb, index)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent("non-dressings:saveOutfit")
AddEventHandler("non-dressings:saveOutfit", function(name, skin)
	local xPlayer = ESX.GetPlayerFromId(source)
	local count = 0
...
RegisterServerEvent('non-dressings:removeOutfit')
AddEventHandler('non-dressings:removeOutfit', function(index)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('non-dressings:getSharedDressing', function(source, cb, job)
	local dressignsLabels = {}
...
ESX.RegisterServerCallback('non-dressings:getSharedOutfit', function(source, cb, index, job)
...
RegisterServerEvent("non-dressings:saveSharedOutfit")
AddEventHandler("non-dressings:saveSharedOutfit", function(name, skin, job)
	local xPlayer = ESX.GetPlayerFromId(source)
	local count = 1
...
RegisterServerEvent('non-dressings:removeSharedOutfit')
AddEventHandler('non-dressings:removeSharedOutfit', function(index, job)
	if not sharedDressings[job] then sharedDressings[job] = {} end
