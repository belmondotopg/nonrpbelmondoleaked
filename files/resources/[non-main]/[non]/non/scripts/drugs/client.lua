...
-- RegisterNetEvent("non_drugs:stop", function()
--     isCollecting = false
--     cancelProgress()
-- end)
...
--             ZC.TriggerSecureServerCallBack('non_drugs:collect', function(count)
--                 if not isCollecting then
--                     isCollecting = true
...
--                         end
--                         ZC.TriggerSecureServerCallBack('non_drugs:stopCollecting')
--                     end)
--                 end
--             end, value.item)
--         elseif zoneType == 'process' then
--             ZC.TriggerSecureServerCallBack('non_drugs:process', function(count)
--                 if not isCollecting then
--                     isCollecting = true
...
--         ZC.RegisterPlace(value.coords, {type = 1, size = vector3(5.0, 5.0, 1.0)}, value.text,
--         function()
