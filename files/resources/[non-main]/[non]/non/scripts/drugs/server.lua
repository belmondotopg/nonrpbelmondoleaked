...
--                         TriggerClientEvent("non_drugs:stop", src)
...
-- ESX.RegisterServerCallback('non_drugs:collect', function(src, cb, itemName)
-- 	local xPlayer = ESX.GetPlayerFromId(src)
--     local count = 0
...
-- ESX.RegisterServerCallback('non_drugs:process', function(src, cb, itemName)
-- 	local xPlayer = ESX.GetPlayerFromId(src)
...
-- ESX.RegisterServerCallback('non_drugs:stopCollecting', function(src)
--     playersCollecting[src] = nil
-- end)