RegisterServerEvent('non:useHealer')
AddEventHandler('non:useHealer', function()
    ...
    if not isClose then
        exports["non-afk"]:fg_BanPlayer(src, "non:useHealer", true)
        -- exports['non-interiors']:banPlayer(xPlayer.source, 'non:useHealer', false, GetCurrentResourceName())
        return
    end
