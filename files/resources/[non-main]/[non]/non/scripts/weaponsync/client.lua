local WeaponsConfig = {
    Weapons = {
		-- ADDON
		["non_vandal"] = `WEAPON_GLITCHPOPVANDAL`,
		["non_ump45"] = `WEAPON_UMP45`,
		-- ["non_m270d"] = `WEAPON_M270D`,
		["non_m16"] = `WEAPON_TOYM16`,
		["non_m9"] = `WEAPON_M9`,
		["non_mxcvirtus"] = `WEAPON_SIGMXCVIRTUS`,
		["non_xm7"] = `WEAPON_SIGSPEARXM7`,
		["non_sw"] = `WEAPON_SWPOLICE`,
